//FileName: ./Server/_4/FR.app02s/api/api/controllers/fruser.controllers
// --------------------------------------------------------------------------------------------------------
...
//      var pModel          =  require(              '../models/index.js' )[ aModel ]                       //#.(10414.02.8).(11109.11.2 RAM This is undefined because there is no model for 'frauth')
...
, login   : function login( req, res )    { trace( `\nLogin as ${req.body.username}` )              // .(10228.12.4)
