...
//    var   aTests      =  'test4 fetch /countries from json_server'
//    var   aTests      =  'test5 fetch /countries from MySQL Server with fetchJSON'
//    var   aTests      =  'test6 fetch /countries from MySQL Server with fetchCountries'
...
if ( aTests.match( /test2/ ) ) {                                     // Use db.json.js

//     var  pJSON       =   parseJSON( `$(__dirname}/db.json` )
...
if (aTests.match( /test5/ ) ) {                     // Use MySQL_server with fetchJSON
                            ...
                            fetchJSON( `${aAPI_URL}/countries?recs=2` ).then( pJSON => {
